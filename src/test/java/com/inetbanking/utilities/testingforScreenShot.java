/**THis is an independent test just to check if screenshot is being recorded. It is not involved with the 
//Mavelselyoutubehybrid test
 * report for this is generated in myReport.html and 
 * Screenshots are stored under Screenshots folder
 * 
**/
...
public class testingforScreenShot {
 ...
 public void setExtent() {
  ...
  extent.setSystemInfo("user", "Jaya");
 }
 ...
 public void tearDown(ITestResult result) throws IOException {
  if (result.getStatus() == ITestResult.FAILURE) {
   ...
   String screenshotPath = testingforScreenShot.getScreenshot(driver, result.getName());
